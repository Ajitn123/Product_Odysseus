...
public class LocalTravelportTest 
{

	 
	   LocalTravelportLoginpgeobjct lgnpge;
	   LocalTravelportBookingpgeobjct airbk;
	   LocalTravelportPurchasepgeobjct chckout;
...
public void openBroswer(String browser) throws InterruptedException, IOException  
{
 ...
 public void baseClass() throws InterruptedException, IOException  
 {
     ...
     //Save console
     String testResultFile="D:\\Ajit\\Script_SS\\ConsoleError\\Local_TravelportError.txt";
     ...
     ImageIO.write(image01, "PNG", new File("D:\\Ajit\\Script_SS\\LocalTravelport\\1_Loginpage.png"));

     //driver.navigate().to("https://localhost/odyssey/website/air/results.aspx?");
     Thread.sleep(4000);
     lgnpge = PageFactory.initElements(driver, LocalTravelportLoginpgeobjct.class);
     airbk = PageFactory.initElements(driver, LocalTravelportBookingpgeobjct.class);
     chckout = PageFactory.initElements(driver, LocalTravelportPurchasepgeobjct.class);
...
public void Confirmlogin_data(String sUsername, String sPassword, String FromLocation, String ToLocation, String Firstname_Of_Adult1, String Middlename_of_Adult1, String Lastname_Of_Adult1, String Firstname_Of_Adult2, String Middlename_of_Adult2, String Lastname_Of_Adult2, String Firstname_Of_Adult3, String Middlename_of_Adult3, String Lastname_Of_Adult3, String Firstname_Of_Infunt4, String Middlename_of_Infunt4, String Lastname_Of_Infunt4, String Firstname_Of_SeatInfunt5, String Middlename_of_SeatInfunt5, String Lastname_Of_SeatInfunt5, String Email, String ConEmail, String Phone_No, String DestinationPhone_No, String CardHolderName, String CardNo, String CardCvvNo, String Address, String City, String Zipcode, String Phone_Number, String Bank_No) throws Exception
{
 try
 {  
 	 Reporter.log("Website Name:- Parth");
 	 Reporter.log("Affiliate Name:- Odysseus-SPC");
      ...
      ImageIO.write(image, "PNG", new File("D:\\Ajit\\Script_SS\\LocalTravelport\\2_Searchpage.png"));
   ...
   catch(Exception e)
   {
	      ...
	      ImageIO.write(image1, "PNG", new File("D:\\Ajit\\Script_SS\\LocalTravelportError\\1_Invalidcredentials.png"));
...
*/	         
		     ...
		     ImageIO.write(image003, "PNG", new File("D:\\Ajit\\Script_SS\\LocalTravelport\\3_Resultpage.png"));
       ...
       else 
       {
		         ...
		         ImageIO.write(image2, "PNG", new File("D:\\Ajit\\Script_SS\\LocalTravelportError\\2_Flightnotavailable.png"));
          ...
          Thread.sleep(1000);
		      ...
		      ImageIO.write(image3, "PNG", new File("D:\\Ajit\\Script_SS\\LocalTravelport\\4_Checkoutpage.png"));
 ...
 catch(Exception e)
 {
		 ...
		 ImageIO.write(image4, "PNG", new File("D:\\Ajit\\Script_SS\\LocalTravelportError\\3_Timeout.png"));
 ...
 try
 {
    //Held Booking
        ...
        ImageIO.write(image12, "PNG", new File("D:\\Ajit\\Script_SS\\LocalTravelport\\5_FlightHeld.png"));
 ...
 catch(Exception e)
 {
      ...
      ImageIO.write(image44, "PNG", new File("D:\\Ajit\\Script_SS\\LocalTravelportError\\5_Statusfail.png"));
    ...
    try
    {
        ...
        ImageIO.write(image74, "PNG", new File("D:\\Ajit\\Script_SS\\LocalTravelport\\6_Paymentpage.png"));
        Thread.sleep(6000);
    ...
    catch(Exception e)
    {
        ...
        ImageIO.write(image94, "PNG", new File("D:\\Ajit\\Script_SS\\LocalTravelportError\\6_Paymentdetails.png"));
  ...
  try
  {
        ...
        Thread.sleep(30000);
            ...
            Thread.sleep(1000);
              ...
              ImageIO.write(image76, "PNG", new File("D:\\Ajit\\Script_SS\\LocalTravelport\\8_ConfirmBooking.png"));
              Thread.sleep(6000);
...
catch (Exception e) 
{
      final Screenshot screenshot94 = new AShot().shootingStrategy(new ViewportPastingStrategy(500)).takeScreenshot(driver);
      final BufferedImage image94 = screenshot94.getImage();
      ImageIO.write(image94, "PNG", new File("D:\\Ajit\\Script_SS\\LocalTravelportError\\7_Paymentpage.png"));
  ...
  Thread.sleep(100);
	      ...
	      ImageIO.write(image11, "PNG", new File("D:\\Ajit\\Script_SS\\LocalTravelport\\9_Admindefaultpage.png"));
...
try
{
  ...
  ExtractJSLogs();
    ...
    Thread.sleep(200);
	      ...
	      ImageIO.write(image16, "PNG", new File("D:\\Ajit\\Script_SS\\LocalTravelport\\10_Crosscheckbookingpopup.png"));
...
}catch(Exception e)
{
   ...
   ExtractJSLogs();
	 ...
	 ImageIO.write(image17, "PNG", new File("D:\\Ajit\\Script_SS\\LocalTravelportError\\8_CrosscheckbookingFail.png"));
...
try
{
  ...
  ExtractJSLogs();
    ...
    Thread.sleep(200);
          ...
          final Screenshot screenshot16 = new AShot().shootingStrategy(new ViewportPastingStrategy(500)).takeScreenshot(driver);
	      final BufferedImage image16 = screenshot16.getImage();
	      ImageIO.write(image16, "PNG", new File("D:\\Ajit\\Script_SS\\LocalTravelport\\10_Cancelbookingpopup.png"));
...
}catch(Exception e)
{
   ...
   ExtractJSLogs();
     ...
     final Screenshot screenshot17 = new AShot().shootingStrategy(new ViewportPastingStrategy(500)).takeScreenshot(driver);
	 final BufferedImage image17 = screenshot17.getImage();
	 ImageIO.write(image17, "PNG", new File("D:\\Ajit\\Script_SS\\LocalTravelportError\\8_CancelbookingFail.png"));
   ...
   else
   {
		     ...
		     final Screenshot screenshot18 = new AShot().shootingStrategy(new ViewportPastingStrategy(500)).takeScreenshot(driver);
		 	 ...
		 	 ImageIO.write(image18, "PNG", new File("D:\\Ajit\\Script_SS\\LocalTravelportError\\9_CancelbookingstatusFail.png"));
     ...
     Reporter.log("Actual status is:- " + status2);
	     ...
	     ImageIO.write(image19, "PNG", new File("D:\\Ajit\\Script_SS\\LocalTravelport\\12_Bookingcancelled.png"));
