	    ...
	    public void DPB2C_data(String sUsername, String sPassword, String tolocatn, String Firstname_GuestOne, String Middlename_GuestOne, String Lastname_GuestOne, String Firstname_GuestTwo, String Middlename_GuestTwo, String Lastname_GuestTwo, String Email, String ConfirmEmail, String Phone, String DestinationPhone, String CardHolderName, String CardNo, String CardCvvNo, String Address, String City, String Zipcode, String Phone_Number, String Bank_Name) throws Exception
	    {
	      ...
	      //For the Balcony   
	         ...
	         try
	         {
	        	 ...
	        	 if(driver.findElement(By.cssSelector("[id*='category_3'] > div:nth-child(1) > div.categoryview-price-gride > ul.categoryview-price-gride-even > li.btn-container [class*='booknow primary-btn']")).isDisplayed())
	        	 {
	        	 ...
	        	 if(driver.findElement(By.cssSelector("#category_4 > div.categoryview-container > div.categoryview-price-gride > ul.categoryview-price-gride-even > li.btn-container > a.booknow.primary-btn")).isDisplayed())
	        	 {
	        		 driver.findElement(By.cssSelector("#category_4 > div.categoryview-container > div.categoryview-price-gride > ul.categoryview-price-gride-even > li.btn-container > a.booknow.primary-btn")).click();
	        		 Thread.sleep(3000);
	        	 }
