 ...
 */
  ...
  public void DLC_data(String sUsername, String sPassword, String tolocatn, String Firstname_GuestOne, String Middlename_GuestOne, String Lastname_GuestOne, String Firstname_GuestTwo, String Middlename_GuestTwo, String Lastname_GuestTwo, String Email, String ConfirmEmail, String Phone, String DestinationPhone, String CardHolderName, String CardNo, String CardCvvNo, String Address, String City, String Zipcode, String Phone_Number, String Bank_Name) throws Exception
  {
      ...
      catch(Exception e)
      {
	         ...
	         ImageIO.write(image33, "PNG", new File("D:\\Ajit\\Script_SS\\LocallyOpenSegmentError\\1_TimeoutORinvalidsearchdetails.png"));
  	...
  	try
    {
        ...
        for(int i = driver.getWindowHandles().size() -1 ; i > 0 ; i--)
        {
		               ...
		               ImageIO.write(image003, "PNG", new File("D:\\Ajit\\Script_SS\\LocallyOpenSegment\\2_Resultpage.png"));
    ...
    catch(Exception e)
    {
           ...
           ImageIO.write(image800, "PNG", new File("D:\\Ajit\\Script_SS\\LocallyOpenSegmentError\\03_Cruisenotselectedoravailable.png"));
		    ...
		    String myArg1 = "D:\\Ajit\\Script_SS\\LocallyOpenSegment\\4_Detailspage.png";
            String myArg2 = "D:\\Ajit\\Script_SS\\Daily Sanity\\Oct_2017\\12 Oct\\LocallyOpenSegment 1\\LocallyOpenSegment\\4_Detailspage.png";
            String myCommand = "D:\\Ajit\\Script_SS\\ImageCompConsole.exe";
            String Output = "D:\\Ajit\\Script_SS\\Differences of Images\\LocallyOpenSegment\\4_Detailspage.png";
		  ...
		  //For the Cruise details page
	        try
	        {
    			...
    			select.selectByVisibleText("Cruise with Air");
    			Thread.sleep(1000);
	      ...
	      //For the Balcony   
	         ...
	         catch(Exception e)
	         {
	        	 e.getMessage();
	                  ...
	                  ImageIO.write(image61, "PNG", new File("D:\\Ajit\\Script_SS\\LocallyOpenSegment\\5_Categorypage.png"));
	                  Thread.sleep(2000);
	                  
	                  String myArg3 = "D:\\Ajit\\Script_SS\\LocallyOpenSegment\\5_Categorypage.png";
	                  ...
	                  String Output1 = "D:\\Ajit\\Script_SS\\Differences of Images\\LocallyOpenSegment\\5_Categorypage.png";
	         ...
	         try
	         {
	             //For select category on the category page
	              driver.findElement(By.cssSelector("[id*='category_3'] > div:nth-child(1) > div.categoryview-price-gride > ul.categoryview-price-gride-even > li.btn-container [class*='booknow primary-btn']")).click();
	              Thread.sleep(3000);
	           ...
	           try
	           {
	            	...
	            	if(driver.findElement(By.cssSelector("#main-content > div.site-content.scw-690 > div > div:nth-child(6) > div > div > div > table > tbody > tr:nth-child(2) > td")).isDisplayed())
	            	{
	            	    ...
	            	    final Screenshot screenshot87 = new AShot().shootingStrategy(new ViewportPastingStrategy(500)).takeScreenshot(driver);
	     	            ...
	     	            ImageIO.write(image87, "PNG", new File("D:\\Ajit\\Script_SS\\LocallyOpenSegmentError\\04_Erroroncategorypage.png"));
	     	          
	          	        Assert.assertFalse(false, "FAIL");
	          	        AssertJUnit.assertTrue("Error on categpry page..: " +err, crsbkng.isDisplayed());
	          	        return;
	            	}
	           }
	           catch(Exception e)
	         ...
	         catch(Exception e)
	         {
	          	   final Screenshot screenshot80 = new AShot().shootingStrategy(new ViewportPastingStrategy(500)).takeScreenshot(driver);
		           final BufferedImage image80 = screenshot80.getImage();
		           ImageIO.write(image80, "PNG", new File("D:\\Ajit\\Script_SS\\LocallyOpenSegmentError\\4_Pricenotavailableoncategorypage.png"));
		          
	     	       Assert.assertFalse(false, "FAIL");
	     	       Reporter.log("Category not availabe...");
	     	       AssertJUnit.assertTrue("Category not availabe...", crsbkng.isDisplayed());
	     	       throw(e);
	          }	    
	               ...
	               ImageIO.write(image62, "PNG", new File("D:\\Ajit\\Script_SS\\LocallyOpenSegment\\6_Cabinselectionpage.png"));
	               Thread.sleep(3000);
	               
	               String myArg5 = "D:\\Ajit\\Script_SS\\LocallyOpenSegment\\6_Cabinselectionpage.png";
	               ...
	               String Output3 = "D:\\Ajit\\Script_SS\\Differences of Images\\LocallyOpenSegment\\6_Cabinpage.png";
	          ...
	          catch(Exception e)
	          {
	                                  ...
	                                  ImageIO.write(image13, "PNG", new File("D:\\Ajit\\Script_SS\\LocallyOpenSegmentError\\4_Cabinnotavailable.png"));
	                                  ...
	                                  Assert.assertFalse(false, "FAIL");
	                                   ...
	                                   ImageIO.write(image102, "PNG", new File("D:\\Ajit\\Script_SS\\LocallyOpenSegment\\7_Purchasepage.png"));
	                                   Thread.sleep(2000);
	                                   
	                                   String myArg7 = "D:\\Ajit\\Script_SS\\LocallyOpenSegment\\7_Purchasepage.png";
	                                   ...
	                                   String Output4 = "D:\\Ajit\\Script_SS\\Differences of Images\\LocallyOpenSegment\\7_Purchasepage.png";
	             ...
	             try
	             {
	               ...
	               catch(Exception e)
	               {
	                                        ...
	                                        ImageIO.write(image34, "PNG", new File("D:\\Ajit\\Script_SS\\LocallyOpenSegmentError\\5_InvalidGuestinfoonPurchasepage.png"));
                     ...
                     //For Payment Gateway
                    		...
                    		catch(Exception e)
                    		{
                    			...
                    			final Screenshot screenshot13 = new AShot().shootingStrategy(new ViewportPastingStrategy(500)).takeScreenshot(driver);
                                final BufferedImage image13 = screenshot13.getImage();
                                ImageIO.write(image13, "PNG", new File("D:\\Ajit\\Script_SS\\LocallyOpenSegmentError\\5_InvalidPaymentdetails.png"));
                          
                                 Assert.assertFalse(false, "FAIL");
           	                     Reporter.log("Payment details are Invalid..");
           			             AssertJUnit.assertTrue("Payment details are Invalid...", crspurchpge.isDisplayed());
           			             throw(e);
                    		}
                    		...
                    		catch(Exception e)
                    		{
                    			e.getMessage();
                    		 	final Screenshot screenshot13 = new AShot().shootingStrategy(new ViewportPastingStrategy(500)).takeScreenshot(driver);
                                final BufferedImage image13 = screenshot13.getImage();
                                ImageIO.write(image13, "PNG", new File("D:\\Ajit\\Script_SS\\LocallyOpenSegmentError\\6_ConfirmBookingButtonNotClick.png"));
                          
                                 Assert.assertFalse(false, "FAIL");
           	                     Reporter.log("Confirm booking button not click...");
           			             AssertJUnit.assertTrue("Confirm booking button not click...", crspurchpge.isDisplayed());
           			             throw(e);
                    		}
                                 ...
                                 ImageIO.write(image107, "PNG", new File("D:\\Ajit\\Script_SS\\LocallyOpenSegment\\8_Confirmationpage.png"));
                                 Thread.sleep(2000);
                           
                                 String myArg9 = "D:\\Ajit\\Script_SS\\LocallyOpenSegment\\8_Confirmationpage.png";
                                 ...
                                 String Output5 = "D:\\Ajit\\Script_SS\\Differences of Images\\LocallyOpenSegment\\8_Confirmationpage.png";
