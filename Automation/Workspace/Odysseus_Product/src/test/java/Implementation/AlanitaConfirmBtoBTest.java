...
public class AlanitaConfirmBtoBTest 
{
    ...
    public void openBroswer(String browser) throws InterruptedException, IOException  
    {
     ...
     @BeforeClass
  	 public void baseClass() throws InterruptedException, IOException  
  	 {
         ...
         //Save console
         String testResultFile="D:\\Ajit\\Script_SS\\ConsoleError\\AlanitaConfirmbookingError.txt";
         ...
         ImageIO.write(image01, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaConfirm\\1_Loginpage.png"));
   ...
   catch(Exception e)
   {
      	          ...
      	          ImageIO.write(image1, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaConfirmError\\0_Invalidcredentials.png"));
    ...
    try
    {
          ...
          ImageIO.write(image, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaConfirm\\2_Searchpage.png"));
    ...
    catch(Exception e)
    {
	       ...
	       final Screenshot screenshot1 = new AShot().shootingStrategy(new ViewportPastingStrategy(500)).takeScreenshot(driver);
	       final BufferedImage image1 = screenshot1.getImage();
	       ImageIO.write(image1, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaConfirmError\\1_InvaliddetailsorError.png"));
    ...
    for(int i = driver.getWindowHandles().size() -1 ; i > 0 ; i--)
    {
           ...
           ImageIO.write(image04, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaConfirm\\3_Resultpage.png"));
      ...
      else 
      {
          ...
          ImageIO.write(image2, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaConfirmError\\2_Flightnotavailable.png"));
           ...
           ImageIO.write(image3, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaConfirm\\4_Checkoutpage.png"));
   ...
   try
   {
    ...
    catch(Exception e)
    {
		  ...
		  ImageIO.write(image4, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaConfirmError\\3_Timeouterror.png"));
       ...
       catch(Exception e)
       {
        		 ...
        		 ImageIO.write(image8, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaConfirmError\\7_Timeouterror.png"));
          ...
          catch(Exception e)
          {
               ...
               ImageIO.write(image44, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaConfirmError\\Statusfail.png"));
  ...
  /*       
        ...
        try
        {
                 ...
                 if(Passengerfirstnme.trim().length()<=29)
                 {
 		             ...
 		             ImageIO.write(image5, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaConfirmError\\9_Invalidfirstname.png"));
        ...
        try
        {
                 ...
                 if(Passengermdlnme.trim().length()<=29)
                 {
 		             ...
 		             ImageIO.write(image6, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaConfirmError\\10_Invalidlastname.png"));
        ...
        try
        {
                 ...
                 if(Passengerlastnme.trim().length()<=29)
                 {
                 	 ...
                 	 final Screenshot screenshot6 = new AShot().shootingStrategy(new ViewportPastingStrategy(500)).takeScreenshot(driver);
 		             final BufferedImage image6 = screenshot6.getImage();
 		             ImageIO.write(image6, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaConfirmError\\11_Invalidlastname.png"));
          ...
          try
          {
                 ...
                 if(Passengerfirstnme2.trim().length()<=29)
                 {
 		             ...
 		             ImageIO.write(image7, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaConfirmError\\11_Invalidfirstname2.png"));
          ...
          try
          {
                 ...
                 if(Passengermdlnme2.trim().length()<=29)
                 {
                 	 ...
                 	 Reporter.log("Error message: " +Passengermdlnme2);	
     	       	     ...
     	       	     final Screenshot screenshot8 = new AShot().shootingStrategy(new ViewportPastingStrategy(500)).takeScreenshot(driver);
 		             final BufferedImage image8 = screenshot8.getImage();
 		             ImageIO.write(image8, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaConfirmError\\12_Invalidlastname2.png"));
          ...
          try
          {
                 ...
                 if(Passengerlastnme2.trim().length()<=29)
                 {
                 	 ...
                 	 Reporter.log("Error message: " +Passengerlastnme2);	
     	       	     ...
     	       	     final Screenshot screenshot8 = new AShot().shootingStrategy(new ViewportPastingStrategy(500)).takeScreenshot(driver);
 		             final BufferedImage image8 = screenshot8.getImage();
 		             ImageIO.write(image8, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaConfirmError\\13_Invalidlastname2.png"));
          ...
          try
          {
                 ...
                 if(Passengerfirstnme3.trim().length()<=29)
                 {
 		             ...
 		             ImageIO.write(image9, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaConfirmError\\13_Invalidfirstname3.png"));
          ...
          try
          {
                 ...
                 if(Passengermdlnme3.trim().length()<=29)
                 {
 		             ...
 		             ImageIO.write(image10, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaConfirmError\\14_Invalidlastname3.png"));
   ...
   */       
       ...
       try
       {
            ...
            else
            {
	             ...
	             ImageIO.write(image11, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaConfirmError\\ConfirmbookingFail.png"));
             ...
             ImageIO.write(image12, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaConfirmError\\FlightConfirmed.png"));
       ...
       catch(Exception e)
       {
            ...
            final Screenshot screenshot7 = new AShot().shootingStrategy(new ViewportPastingStrategy(500)).takeScreenshot(driver);
   	        final BufferedImage image7 = screenshot7.getImage();
   	        ImageIO.write(image7, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaConfirmError\\18_Timeout.png"));
