...
public class CruiseQuickTest 
{
	 
	 CDORPurchasepageobjct crspurchpge;
	 CruiseQuickBookingpgeobjct crsbkngpge;
     public static WebDriver driver;
     Reporter report = new Reporter();
     
     String Log = "D:\\Ajit\\Script_SS\\Differences of Images\\Logs\\CruiseQuick.txt";
 ...
 public void openBroswer(String browser) throws InterruptedException, IOException  
 {
   ...
   public void baseClass() throws InterruptedException, IOException  
   {
       ...
       driver.navigate().to("https://book.cruisequick.com/web/cruises/search.aspx");
       Thread.sleep(4000);

       //Save console
       String testResultFile="D:\\Ajit\\Script_SS\\ConsoleError\\CruiseQuickBookingError.txt";
       ...
       ImageIO.write(image1, "PNG", new File("D:\\Ajit\\Script_SS\\CruiseQuick\\1_Searchpage.png"));
       Thread.sleep(1000);
       
       String myArg1 = "D:\\Ajit\\Script_SS\\CruiseQuick\\1_Searchpage.png";
       String myArg2 = "D:\\Ajit\\Script_SS\\Daily Sanity\\Oct_2017\\11 Oct\\CruiseQuick\\CruiseQuick\\1_Searchpage.png";
       String myCommand = "D:\\Ajit\\Script_SS\\ImageCompConsole.exe";
       String Output = "D:\\Ajit\\Script_SS\\Differences of Images\\CruiseQuick\\1_Searchpage.png";
      ...
      Thread.sleep(4000);
      crsbkngpge = PageFactory.initElements(driver, CruiseQuickBookingpgeobjct.class);
 ...
 public void CruiseQuick_data(String Firstname_GuestOne, String Middlename_GuestOne, String Lastname_GuestOne, String Email, String Phone, String Firstname_GuestTwo, String Middlename_GuestTwo, String Lastname_GuestTwo) throws Exception
 {
 	...
 	try
     {
		    //For web site and booking details
             Reporter.log("Website Name :- CruiseQuick");
             Thread.sleep(200);
		 
		     Reporter.log("Cruise line :- Princes");
		     Thread.sleep(1500);
     ...
     try
     {
         	  if(driver.findElement(By.cssSelector("#main-content > div.site-content.scw-690 > div > div.error-message-wrapper > div > div > div > table > tbody > tr:nth-child(2) > td")).isDisplayed())
               {
             	   ...
             	   final Screenshot screenshot87 = new AShot().shootingStrategy(new ViewportPastingStrategy(500)).takeScreenshot(driver);
   	               ...
   	               ImageIO.write(image87, "PNG", new File("D:\\Ajit\\Script_SS\\CruiseQuickError\\04_Erroronresultpage.png"));
     ...
     catch(Exception e)
     {
            ...
            ImageIO.write(image4, "PNG", new File("D:\\Ajit\\Script_SS\\CruiseQuick\\2_Resultpage.png"));
        
            Thread.sleep(6000);
            
            String myArg1 = "D:\\Ajit\\Script_SS\\CruiseQuick\\2_Resultpage.png";
            String myArg2 = "D:\\Ajit\\Script_SS\\Daily Sanity\\Oct_2017\\11 Oct\\CruiseQuick\\CruiseQuick\\2_Resultpage.png";
            String myCommand = "D:\\Ajit\\Script_SS\\ImageCompConsole.exe";
            String Output = "D:\\Ajit\\Script_SS\\Differences of Images\\CruiseQuick\\2_Resultpage.png";
     ...
     catch(Exception e)
     {
	         ...
	         ImageIO.write(image33, "PNG", new File("D:\\Ajit\\Script_SS\\CruiseQuickError\\1_TimeoutORinvalidsearchdetails.png"));
     ...
     try
     {
                   ...
                   driver.get("https://book.cruisequick.com/web/cruises/results.aspx?showtrace=true");
                   ...
                   if(driver.findElement(By.cssSelector("[id*='PriceList_'] > div > ul > li.grid-bonus.res_grid_bonus > div > a [class*='promo-name-red']")).isDisplayed())
                   {
                      ...
                      Thread.sleep(1500);
                       ...
                       File scr22 = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
         	           org.codehaus.plexus.util.FileUtils.copyFile(scr22, new File("D:\\Ajit\\Script_SS\\CruiseQuick\\3_Bonusoffers.png")); 
                       
                       Thread.sleep(3000);
                       
                       String myArg1 = "D:\\Ajit\\Script_SS\\CruiseQuick\\3_Bonusoffers.png";
                       String myArg2 = "D:\\Ajit\\Script_SS\\Daily Sanity\\Oct_2017\\11 Oct\\CruiseQuick\\CruiseQuick\\3_Bonusoffers.png";
                       String myCommand = "D:\\Ajit\\Script_SS\\ImageCompConsole.exe";
                       String Output = "D:\\Ajit\\Script_SS\\Differences of Images\\CruiseQuick\\3_Bonusoffers.png";
	      ...
	      catch(Exception e)
	      {
                 ...
                 ImageIO.write(image5, "PNG", new File("D:\\Ajit\\Script_SS\\CruiseQuickError\\2_Cruisenotavailable.png"));
             ...
             ImageIO.write(image60, "PNG", new File("D:\\Ajit\\Script_SS\\CruiseQuick\\4_Cruisedetailspage.png"));
             Thread.sleep(2000);
             
             String myArg11 = "D:\\Ajit\\Script_SS\\CruiseQuick\\4_Cruisedetailspage.png";
             String myArg12 = "D:\\Ajit\\Script_SS\\Daily Sanity\\Oct_2017\\11 Oct\\CruiseQuick\\CruiseQuick\\4_Cruisedetailspage.png";
             String myCommand7 = "D:\\Ajit\\Script_SS\\ImageCompConsole.exe";
             String Output7 = "D:\\Ajit\\Script_SS\\Differences of Images\\CruiseQuick\\4_Cruisedetailspage.png";
           ...
           //For the Cruise details print on test report
             String depart = driver.findElement(By.cssSelector("#wrapper > div.content > div.content-area > div.content-left > div.cruise-details-outer.res_cruise_details > div > div.cruise-details > ul > li:nth-child(3)")).getText();
             Reporter.log("" +depart);
             Thread.sleep(500);
             ...
             Reporter.log("" +dstntn);
             Thread.sleep(400);
             String drtn = driver.findElement(By.cssSelector("#wrapper > div.content > div.content-area > div.content-left > div.cruise-details-outer.res_cruise_details > div > div.cruise-details > ul > li:nth-child(4)")).getText();
             Reporter.log("" + drtn);
             Thread.sleep(400);
      ...
      catch(Exception e)
      {
                System.out.println("\n");
   	            ...
   	            ImageIO.write(image80, "PNG", new File("D:\\Ajit\\Script_SS\\CruiseQuickError\\3_InvalidGuestinformation.png"));
               ...
               ImageIO.write(image61, "PNG", new File("D:\\Ajit\\Script_SS\\CruiseQuick\\5_Categorypage.png"));
               Thread.sleep(3000);
               
               String myArg3 = "D:\\Ajit\\Script_SS\\CruiseQuick\\5_Categorypage.png";
               String myArg4 = "D:\\Ajit\\Script_SS\\Daily Sanity\\Oct_2017\\11 Oct\\CruiseQuick\\CruiseQuick\\5_Categorypage.png";
               String myCommand1 = "D:\\Ajit\\Script_SS\\ImageCompConsole.exe";
               String Output1 = "D:\\Ajit\\Script_SS\\Differences of Images\\CruiseQuick\\5_Categorypage.png";
     ...
     //	 driver.findElement(By.cssSelector("#main-item > table > tbody > tr > td:nth-child(4) > div > a > span [class*='hidden-xs hidden-sm']")).click();
     	 WebElement element = driver.findElement(By.cssSelector("[id*='category_'] > div:nth-child(1) > div.categoryview-price-gride > ul:nth-child(4) > li.book-btn.btn-container [class*='booknow primary-btn']"));
        ...
        try
        {
         	...
         	if(driver.findElement(By.cssSelector("#main-content > div.site-content.scw-690 > div > div:nth-child(6) > div > div > div > table > tbody > tr:nth-child(2) > td")).isDisplayed())
         	{
         	    ...
         	    final Screenshot screenshot87 = new AShot().shootingStrategy(new ViewportPastingStrategy(500)).takeScreenshot(driver);
  	            final BufferedImage image87 = screenshot87.getImage();
  	            ImageIO.write(image87, "PNG", new File("D:\\Ajit\\Script_SS\\CruiseQuickError\\04_Erroroncategorypage.png"));
      ...
      catch(Exception e)
      {
       	       final Screenshot screenshot80 = new AShot().shootingStrategy(new ViewportPastingStrategy(500)).takeScreenshot(driver);
	           final BufferedImage image80 = screenshot80.getImage();
	           ImageIO.write(image80, "PNG", new File("D:\\Ajit\\Script_SS\\CruiseQuickError\\4_Pricenotavailableoncategorypage.png"));
            ...
            ImageIO.write(image62, "PNG", new File("D:\\Ajit\\Script_SS\\CruiseQuick\\6_Cabinselectionpage.png"));
            Thread.sleep(3000);
            
            String myArg5 = "D:\\Ajit\\Script_SS\\CruiseQuick\\6_Cabinselectionpage.png";
            String myArg6 = "D:\\Ajit\\Script_SS\\Daily Sanity\\Oct_2017\\11 Oct\\CruiseQuick\\CruiseQuick\\6_Cabinselectionpage.png";
            String myCommand3 = "D:\\Ajit\\Script_SS\\ImageCompConsole.exe";
            String Output3 = "D:\\Ajit\\Script_SS\\Differences of Images\\CruiseQuick\\6_Cabinpage.png";
       ...
       catch(Exception e)
       {
                               ...
                               ImageIO.write(image13, "PNG", new File("D:\\Ajit\\Script_SS\\CruiseQuickError\\4_Cabinnotavailable.png"));
                              ...
                              Assert.assertFalse(false, "FAIL");
                                ...
                                ImageIO.write(image102, "PNG", new File("D:\\Ajit\\Script_SS\\CruiseQuick\\7_Purchasepage.png"));
                                Thread.sleep(2000);
                                
                                String myArg7 = "D:\\Ajit\\Script_SS\\CruiseQuick\\7_Purchasepage.png";
                                String myArg8 = "D:\\Ajit\\Script_SS\\Daily Sanity\\Oct_2017\\11 Oct\\CruiseQuick\\CruiseQuick\\7_Purchasepage.png";
                                String myCommand4 = "D:\\Ajit\\Script_SS\\ImageCompConsole.exe";
                                String Output4 = "D:\\Ajit\\Script_SS\\Differences of Images\\CruiseQuick\\7_Purchasepage.png";
          ...
          try
          {
            ...
            catch(Exception e)
            {
                                     ...
                                     ImageIO.write(image34, "PNG", new File("D:\\Ajit\\Script_SS\\CruiseQuickError\\5_InvalidGuestinfoonPurchasepage.png"));
                               ...
                               try
                               {
                                	//For the Address details
                                      ...
                                      elll.sendKeys("Miami");
                                      Thread.sleep(800);
                                      Select select = new Select(driver.findElement(By.xpath("//*[@id='_ctl0_MainContentsPH__ctl0_TravelerAccount_1_AddressUC_StateSel']")));
                               ...
                               try
                               {
                                    ...
                                    ImageIO.write(image44, "PNG", new File("D:\\Ajit\\Script_SS\\CruiseQuick\\8_ConfirmBookingpage.png"));
                                    Thread.sleep(2000);
                               ...
                               catch(Exception e)
                               {
                            	   e.getMessage();
                                     ...
                                     final Screenshot screenshot44 = new AShot().shootingStrategy(new ViewportPastingStrategy(500)).takeScreenshot(driver);
                                     final BufferedImage image44 = screenshot44.getImage();
                                     ImageIO.write(image44, "PNG", new File("D:\\Ajit\\Script_SS\\CruiseQuick\\9_Paymentpage.png"));
                                     Thread.sleep(2000);
                                     
                                     String myArg9 = "D:\\Ajit\\Script_SS\\CruiseQuick\\9_Paymentpage.png";
                                     String myArg10 = "D:\\Ajit\\Script_SS\\Daily Sanity\\Oct_2017\\11 Oct\\CruiseQuick\\CruiseQuick\\9_Paymentpage.png";
                                     String myCommand5 = "D:\\Ajit\\Script_SS\\ImageCompConsole.exe";
                                     String Output5 = "D:\\Ajit\\Script_SS\\Differences of Images\\CruiseQuick\\9_Paymentpage.png";
              ...
              /*      							 
                  ...
                  */   				
                    			//For the compare logs
                    			 String ConsleArgument = "D:\\Ajit\\Script_SS\\ConsoleError\\CruiseQuickBookingError.txt";
                                 String ConsoleCommand = "D:\\Ajit\\Script_SS\\ConsoleApplication2.exe";
                                 String ConsoleOutput = "D:\\Ajit\\Script_SS\\CruiseQuickError\\UncaughtCruiseQuick.txt";
