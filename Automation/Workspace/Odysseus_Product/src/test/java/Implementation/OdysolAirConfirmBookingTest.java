...
public class OdysolAirConfirmBookingTest 
{

	   Login lgnpge;
	   OdysolAirBookingpgeobjct airbk;
	   OdysolAirCheckoutpageobjct chckout;
	   OdysolAirConfirmpgeobjct hldncnfrm;
	   public static WebDriver driver;
       Reporter report = new Reporter();
       static final ExtentReports extent = ExtentReports.get(OdysolAirConfirmBookingTest.class);
    ...
    public void Confirmlogin_data(String sUsername, String sPassword, String FromLocation, String ToLocation, String Firstname_Of_Adult1, String Middlename_of_Adult1, String Lastname_Of_Adult1, String Firstname_Of_Adult2, String Middlename_of_Adult2, String Lastname_Of_Adult2, String Firstname_Of_Adult3, String Middlename_of_Adult3, String Lastname_Of_Adult3, String Email, String Confirm_Email, String Phone_No, String CardHolderName, String CardNo, String CardCvvNo, String Address, String City, String Zipcode, String Phone_Number, String BankName) throws Exception
    {
       ...
       {  
    	   extent.init("D:\\Ajit\\Automation\\Workspace\\Odysseus_Product\\test-output\\emailable-report.html", true);
   	       extent.startTest("OdysolAirConfirmBookingTest");
       ...
       catch(Exception e)
       {
        	          ...
        	          ImageIO.write(image1, "PNG", new File("D:\\Ajit\\Script_SS\\OdysolAirConfirmError\\0_Invalidcredentials.png"));
        ...
        try
        {
           ...
           ImageIO.write(image, "PNG", new File("D:\\Ajit\\Script_SS\\OdysolAirConfirm\\2_Searchpage.png"));
       ...
       catch(Exception e)
       {
 	       ...
 	       final Screenshot screenshot1 = new AShot().shootingStrategy(new ViewportPastingStrategy(500)).takeScreenshot(driver);
 	       final BufferedImage image1 = screenshot1.getImage();
 	       ImageIO.write(image1, "PNG", new File("D:\\Ajit\\Script_SS\\OdysolAirConfirmError\\1_InvaliddetailsorError.png"));
      ...
      for(int i = driver.getWindowHandles().size() -1 ; i > 0 ; i--)
      {
		   ...
		   ImageIO.write(image003, "PNG", new File("D:\\Ajit\\Script_SS\\OdysolAirConfirm\\3_Resultpage.png"));
          ...
          else 
          {
		       ...
		       ImageIO.write(image2, "PNG", new File("D:\\Ajit\\Script_SS\\OdysolAirConfirmError\\2_Invalidcredentials.png"));
		   ...
		   ImageIO.write(image3, "PNG", new File("D:\\Ajit\\Script_SS\\OdysolAirConfirm\\4_Checkoutpage.png"));
    ...
    catch(Exception e)
    {
	    ...
	    ImageIO.write(image4, "PNG", new File("D:\\Ajit\\Script_SS\\OdysolAirConfirmError\\3_Timeouterror.png"));
    ...
    try
    {
         ...
         //   System.out.println("BankName: " + BankName);
              ...
              hldncnfrm.ConfirmToTitle(CardHolderName, CardNo, CardCvvNo, Address, City, Zipcode, Phone_Number);
    }
    catch(Exception e)
    {
           	  System.out.println("\n");
             ...
             final Screenshot screenshot8 = new AShot().shootingStrategy(new ViewportPastingStrategy(500)).takeScreenshot(driver);
     		 ...
     		 ImageIO.write(image8, "PNG", new File("D:\\Ajit\\Script_SS\\OdysolAirConfirmError\\7_Timeouterror.png"));
       ...
       catch(Exception e)
       {
           ...
           ImageIO.write(image44, "PNG", new File("D:\\Ajit\\Script_SS\\OdysolAirConfirmError\\8_Statusfail.png"));
      	 
           Assert.assertFalse(false, "FAIL");
     	   Reporter.log("Confirm button not click because Production Environment..");
           AssertJUnit.assertTrue("Confirm button not click because Production Environment...", chckout.isDisplayed());
           throw(e);
       }
...
/*            
       ...
       try
       {
                ...
                if(Passengerfirstnme.trim().length()<=29)
                {
		             ...
		             ImageIO.write(image5, "PNG", new File("D:\\Ajit\\Script_SS\\OdysolAirConfirmError\\9_Invalidfirstname.png"));
       ...
       try
       {
                ...
                if(Passengermdlnme.trim().length()<=29)
                {
		             ...
		             ImageIO.write(image6, "PNG", new File("D:\\Ajit\\Script_SS\\OdysolAirConfirmError\\10_Invalidlastname.png"));
       ...
       try
       {
                ...
                if(Passengerlastnme.trim().length()<=29)
                {
                	 ...
                	 final Screenshot screenshot6 = new AShot().shootingStrategy(new ViewportPastingStrategy(500)).takeScreenshot(driver);
		             final BufferedImage image6 = screenshot6.getImage();
		             ImageIO.write(image6, "PNG", new File("D:\\Ajit\\Script_SS\\OdysolAirConfirmError\\11_Invalidlastname.png"));
         ...
         try
         {
                ...
                if(Passengerfirstnme2.trim().length()<=29)
                {
		             ...
		             ImageIO.write(image7, "PNG", new File("D:\\Ajit\\Script_SS\\OdysolAirConfirmError\\11_Invalidfirstname2.png"));
         ...
         try
         {
                ...
                if(Passengermdlnme2.trim().length()<=29)
                {
                	 ...
                	 Reporter.log("Error message: " +Passengermdlnme2);	
    	       	     ...
    	       	     final Screenshot screenshot8 = new AShot().shootingStrategy(new ViewportPastingStrategy(500)).takeScreenshot(driver);
		             final BufferedImage image8 = screenshot8.getImage();
		             ImageIO.write(image8, "PNG", new File("D:\\Ajit\\Script_SS\\OdysolAirConfirmError\\12_Invalidlastname2.png"));
         ...
         try
         {
                ...
                if(Passengerlastnme2.trim().length()<=29)
                {
                	 ...
                	 Reporter.log("Error message: " +Passengerlastnme2);	
    	       	     ...
    	       	     final Screenshot screenshot8 = new AShot().shootingStrategy(new ViewportPastingStrategy(500)).takeScreenshot(driver);
		             final BufferedImage image8 = screenshot8.getImage();
		             ImageIO.write(image8, "PNG", new File("D:\\Ajit\\Script_SS\\OdysolAirConfirmError\\13_Invalidlastname2.png"));
         ...
         try
         {
                ...
                if(Passengerfirstnme3.trim().length()<=29)
                {
		             ...
		             ImageIO.write(image9, "PNG", new File("D:\\Ajit\\Script_SS\\OdysolAirConfirmError\\13_Invalidfirstname3.png"));
         ...
         try
         {
                ...
                if(Passengermdlnme3.trim().length()<=29)
                {
		             ...
		             ImageIO.write(image10, "PNG", new File("D:\\Ajit\\Script_SS\\OdysolAirConfirmError\\14_Invalidlastname3.png"));
  ...
  */        
         ...
         try
         {
             ...
             else
             {
	             ...
	             ImageIO.write(image11, "PNG", new File("D:\\Ajit\\Script_SS\\OdysolAirConfirmError\\ConfirmbookingFail.png"));
                ...
                ImageIO.write(image12, "PNG", new File("D:\\Ajit\\Script_SS\\OdysolAirConfirmError\\FlightConfirmed.png"));
         ...
         catch(Exception e)
         {
            ...
            final Screenshot screenshot7 = new AShot().shootingStrategy(new ViewportPastingStrategy(500)).takeScreenshot(driver);
     	    final BufferedImage image7 = screenshot7.getImage();
     	    ImageIO.write(image7, "PNG", new File("D:\\Ajit\\Script_SS\\OdysolAirConfirmError\\18_Timeout.png"));
