...
import Utility.VivaVoyageUtils;
import ru.yandex.qatools.ashot.AShot;
import ru.yandex.qatools.ashot.Screenshot;
import ru.yandex.qatools.ashot.screentaker.ViewportPastingStrategy;


public class VivaVoyageTest
{

	    VivaVoyagePurchasepageobjct crspurchpge;
     ...
     public void openBroswer(String browser) throws InterruptedException, IOException  
     {
        try 
        {
        ...
        } catch (WebDriverException e) 
          {
              ...
              driver.get("https://res.vivavoyage.co.uk/web/cruises/search.aspx?");
              Thread.sleep(2000);
       
              //Save console
              String testResultFile="D:\\Ajit\\Script_SS\\ConsoleError\\VivaVoyagecruisebookingError.txt";
              ...
              Thread.sleep(4000);
              crsbkngpge = PageFactory.initElements(driver, VivaVoyageBookingpgeobjct.class);
              crspurchpge = PageFactory.initElements(driver, VivaVoyagePurchasepageobjct.class);
     ...
     public void Vivavoyage_data(String Email, String Firstname_GuestOne, String Middlename_GuestOne, String Lastname_GuestOne, String Phone, String Firstname_GuestTwo, String Middlename_GuestTwo, String Lastname_GuestTwo) throws Exception
     {
    	 try
         {
    		//For web site and booking details
             Reporter.log("Website Name :- Viva Voyage UK");
             Thread.sleep(200);
    		 
    		 Reporter.log("Cruise line :- Norwegian Cruise Line");
    		 Thread.sleep(2500);
         ...
         catch(Exception e)
         {
        	 System.out.println("\n");
              ...
              try
              {
                            ...
                            driver.get("https://res.vivavoyage.co.uk/web/cruises/results.aspx?showtrace=true");
                             
                            Thread.sleep(3000);  
                                   
                            // For the bonus offers
                            if(driver.findElement(By.xpath("//*[@id='PriceList_0']/div/ul[1]/li[2]/a[2]/img")).isDisplayed())
                            {
    	      ...
    	      catch(Exception e)
    	      {
                      ...
                      String depart = driver.findElement(By.cssSelector("#wrapper > div.content > div.content-area-wrapper > div > div.content-left > div.cruise-details-outer.res_cruise_details > div.search-box > div.cruise-details > ul > li:nth-child(1) > span.Cruise-details-right")).getText();
                      Reporter.log("Departing :- " +depart);
                      Thread.sleep(500);
                      String sailing = driver.findElement(By.cssSelector("#wrapper > div.content > div.content-area-wrapper > div > div.content-left > div.cruise-details-outer.res_cruise_details > div.search-box > div.cruise-details > ul > li:nth-child(2) > span.Cruise-details-right")).getText();
                      Reporter.log("Sailing dates : " +sailing);
                      Thread.sleep(800);
                      String shp = driver.findElement(By.cssSelector("#wrapper > div.content > div.content-area-wrapper > div > div.content-left > div.cruise-details-outer.res_cruise_details > div.search-box > div.cruise-details > ul > li:nth-child(3) > span.Cruise-details-right")).getText();
                      Reporter.log("Ship :- " +shp);
                      Thread.sleep(500);
                      String dstntn = driver.findElement(By.cssSelector("#wrapper > div.content > div.content-area-wrapper > div > div.content-left > div.cruise-details-outer.res_cruise_details > div.search-box > div.cruise-details > ul > li:nth-child(4) > span.Cruise-details-right")).getText();
                      Reporter.log("Destination :- " +dstntn);
                      Thread.sleep(100);
                      String drtn = driver.findElement(By.cssSelector("#wrapper > div.content > div.content-area-wrapper > div > div.content-left > div.cruise-details-outer.res_cruise_details > div.search-box > div.cruise-details > ul > li:nth-child(5) > span.Cruise-details-right")).getText();
               ...
               //For verify error message on category page
               try
               {
                       if(driver.findElement(By.cssSelector("#wrapper > div.content > div.content-area-wrapper > div > div.top-error.error-box > div.top-error-bottom")).isDisplayed())
                       {
                             String err = driver.findElement(By.cssSelector("#wrapper > div.content > div.content-area-wrapper > div > div.top-error.error-box > div.top-error-bottom")).getText();
                             Thread.sleep(300);
               ...
               catch(Exception e)
               {
            	      e.getMessage();
                        ...
                        //For check price on cabin page
                         ...
                         Thread.sleep(2000);
                         String taxes = driver.findElement(By.cssSelector("#wrapper > div.content > div.content-area-wrapper > div > div.content-left > div.cruise-details-outer.res_cruise_details > div.search-box > div.cruise-details > ul:nth-child(3) > li:nth-child(3) > span.Cruise-details-right")).getText();
                         Reporter.log("Taxes And Fees: " +taxes);
                         Thread.sleep(2000);
             ...
             catch(Exception e)
             {
                ...
                try
                {
                                	 ...
                                	 crspurchpge.PurchaseToTittle(Email, Firstname_GuestOne, Middlename_GuestOne, Lastname_GuestOne, Phone, Firstname_GuestTwo, Middlename_GuestTwo, Lastname_GuestTwo);
                                     Thread.sleep(2000);
                }
                catch(Exception e)
                {
