...
public class LocalCDORTest
{
	  
	  LocalCruisebkngLoginpgobjct crsbkng;
	  LocalCDORpgeobjct crsbkngpge;
...
public void baseClass() throws InterruptedException, IOException  
{
   ...
   Thread.sleep(4000);
   crsbkngpge = PageFactory.initElements(driver, LocalCDORpgeobjct.class);
...
public void ADC_data(String sUsername, String sPassword, String Firstname_GuestOne, String Middlename_GuestOne, String Lastname_GuestOne, String Email, String Street_Address, String Cty, String Zpcode, String Phone, String Firstname_GuestTwo, String Middlename_GuestTwo, String Lastname_GuestTwo, String CardNo, String CardCvvNo, String CardHolderName, String Address, String City, String Zipcode, String Phone_Number, String BankName) throws Exception
{
 ...
 catch(Exception e)
 {
     ...
     try
     {
               ...
               driver.findElement(By.cssSelector("#ResultsContainer > div.page-content.mar-lg-top.search > section > div:nth-child(1) > section > table > tbody > tr > td.text-center.btn-td [class*='red-btn']")).click();  // Select cruise i.e 0,1,2,3...10                      
               Thread.sleep(2000);
  ...
  try
  {
             ...
             Thread.sleep(500);
             driver.findElement(By.id("_ctl0_MainContentsPH__ctl0__ctl0_CategoryBTN")).sendKeys(Keys.ENTER);
             Thread.sleep(500);
