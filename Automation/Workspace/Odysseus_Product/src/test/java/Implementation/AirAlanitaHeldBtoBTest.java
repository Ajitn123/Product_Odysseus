...
public class AirAlanitaHeldBtoBTest
{
    ...
    public void openBroswer(String browser) throws InterruptedException, IOException  
    {
      try
      {
      ...
      } catch (WebDriverException e) 
        {
            ...
            //Save console
            String testResultFile="D:\\Ajit\\Script_SS\\ConsoleError\\AlanitaHeldbookingError.txt";
            ...
            ImageIO.write(image01, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaHeld\\1_Loginpage.png"));
    ...
    public void Heldlogin_data(String sUsername, String sPassword, String FromLocation, String ToLocation, String Firstname_Of_Adult1, String Middlename_of_Adult1, String Lastname_Of_Adult1, String Firstname_Of_Adult2, String Middlename_of_Adult2, String Lastname_Of_Adult2, String Firstname_Of_Adult3, String Middlename_of_Adult3, String Lastname_Of_Adult3, String Email, String Confirm_Email, String Phone_No, String CardHolderName, String CardNo, String CardCvvNo, String Address, String City, String Zipcode, String Phone_Number, String BankName) throws Exception
    {
      ...
      catch(Exception e)
      {
         	          ...
         	          ImageIO.write(image1, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaHeldError\\0_Invalidcredentials.png"));
      ...
      try
      {
           ...
           ImageIO.write(image, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaHeld\\2_Searchpage.png"));
      ...
      catch(Exception e)
      {
	       ...
	       final Screenshot screenshot1 = new AShot().shootingStrategy(new ViewportPastingStrategy(500)).takeScreenshot(driver);
	       final BufferedImage image1 = screenshot1.getImage();
	       ImageIO.write(image1, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaHeldError\\1_InvaliddetailsorError.png"));
     ...
     for(int i = driver.getWindowHandles().size() -1 ; i > 0 ; i--)
     {
           ...
           ImageIO.write(image04, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaHeld\\3_Resultpage.png"));
         ...
         else 
         {
            ...
            ImageIO.write(image2, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaHeldError\\2_Flightnotavailable.png"));
            ...
            ImageIO.write(image3, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaHeld\\4_Checkoutpage.png"));
      ...
      try
      {
       ...
       catch(Exception e)
       {
          ...
          final Screenshot screenshot4 = new AShot().shootingStrategy(new ViewportPastingStrategy(500)).takeScreenshot(driver);
  		  ...
  		  ImageIO.write(image4, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaHeldError\\3_Timeouterror.png"));
       ...
       catch(Exception e)
       {
               ...
               ImageIO.write(image44, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaHeldError\\4_Statusfail.png"));
        ...
        try
        {
                 ...
                 if(Passengerfirstnme.trim().length()<=29)
                 {
 		             ...
 		             ImageIO.write(image5, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaHeldError\\9_Invalidfirstname.png"));
        ...
        try
        {
                 ...
                 if(Passengermdlnme.trim().length()<=29)
                 {
 		             ...
 		             ImageIO.write(image6, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaHeldError\\10_Invalidlastname.png"));
        ...
        try
        {
                 ...
                 if(Passengerlastnme.trim().length()<=29)
                 {
                 	 ...
                 	 final Screenshot screenshot6 = new AShot().shootingStrategy(new ViewportPastingStrategy(500)).takeScreenshot(driver);
 		             final BufferedImage image6 = screenshot6.getImage();
 		             ImageIO.write(image6, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaHeldError\\11_Invalidlastname.png"));
          ...
          try
          {
                 ...
                 if(Passengerfirstnme2.trim().length()<=29)
                 {
 		             ...
 		             ImageIO.write(image7, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaHeldError\\11_Invalidfirstname2.png"));
          ...
          try
          {
                 ...
                 if(Passengermdlnme2.trim().length()<=29)
                 {
 		             ...
 		             ImageIO.write(image8, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaHeldError\\12_Invalidlastname2.png"));
          ...
          try
          {
                 ...
                 if(Passengerlastnme2.trim().length()<=29)
                 {
                 	 ...
                 	 Reporter.log("Error message: " +Passengerlastnme2);	
     	       	     ...
     	       	     final Screenshot screenshot8 = new AShot().shootingStrategy(new ViewportPastingStrategy(500)).takeScreenshot(driver);
 		             final BufferedImage image8 = screenshot8.getImage();
 		             ImageIO.write(image8, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaHeldError\\13_Invalidlastname2.png"));
          ...
          try
          {
                 ...
                 if(Passengerfirstnme3.trim().length()<=29)
                 {
 		             ...
 		             ImageIO.write(image9, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaHeldError\\13_Invalidfirstname3.png"));
          ...
          try
          {
                 ...
                 if(Passengermdlnme3.trim().length()<=29)
                 {
 		             ...
 		             ImageIO.write(image10, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaHeldError\\14_Invalidlastname3.png"));
        ...
        try
        {
              ...
              else
              {
     			    ...
     			    final Screenshot screenshot5 = new AShot().shootingStrategy(new ViewportPastingStrategy(500)).takeScreenshot(driver);
     	   		    final BufferedImage image5 = screenshot5.getImage();
     	   		    ImageIO.write(image5, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaHeldError\\5_HeldbookingFail.png"));
                   ...
                   final Screenshot screenshot6 = new AShot().shootingStrategy(new ViewportPastingStrategy(500)).takeScreenshot(driver);
     		       final BufferedImage image6 = screenshot6.getImage();
     		       ImageIO.write(image6, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaHeld\\5_Flightheld.png"));
           ...
           catch(Exception e)
           {
                ...
                final Screenshot screenshot7 = new AShot().shootingStrategy(new ViewportPastingStrategy(500)).takeScreenshot(driver);
        	    final BufferedImage image7 = screenshot7.getImage();
        	    ImageIO.write(image7, "PNG", new File("D:\\Ajit\\Script_SS\\AlanitaHeldError\\18_Timeout.png"));
