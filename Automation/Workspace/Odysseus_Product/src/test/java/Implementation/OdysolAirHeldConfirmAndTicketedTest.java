...
public class OdysolAirHeldConfirmAndTicketedTest 
{
 ...
 /*           
      ...
      try
      {
               ...
               if(Passengerfirstnme.trim().length()<=29)
               {
		         ...
		         ImageIO.write(image5, "PNG", new File("D:\\Ajit\\Script_SS\\OdysolAirHeldConfirmAndTicketedError\\9_Invalidfirstname.png"));
      ...
      try
      {
               ...
               if(Passengermdlnme.trim().length()<=29)
               {
		             ...
		             ImageIO.write(image6, "PNG", new File("D:\\Ajit\\Script_SS\\OdysolAirHeldConfirmAndTicketedError\\10_Invalidlastname.png"));
       ...
       try
       {
               ...
               if(Passengerlastnme.trim().length()<=29)
               {
                 	 System.out.println("Error message: " +Passengerlastnme);
               	     ...
               	     final Screenshot screenshot6 = new AShot().shootingStrategy(new ViewportPastingStrategy(500)).takeScreenshot(driver);
		             final BufferedImage image6 = screenshot6.getImage();
		             ImageIO.write(image6, "PNG", new File("D:\\Ajit\\Script_SS\\OdysolAirHeldConfirmAndTicketedError\\11_Invalidlastname.png"));
        ...
        try
        {
               ...
               if(Passengerfirstnme2.trim().length()<=29)
               {
		             ...
		             ImageIO.write(image7, "PNG", new File("D:\\Ajit\\Script_SS\\OdysolAirHeldConfirmAndTicketedError\\11_Invalidfirstname2.png"));
        ...
        try
        {
               ...
               if(Passengermdlnme2.trim().length()<=29)
               {
		             ...
		             ImageIO.write(image8, "PNG", new File("D:\\Ajit\\Script_SS\\OdysolAirHeldConfirmAndTicketedError\\12_Invalidlastname2.png"));
        ...
        try
        {
               ...
               if(Passengerlastnme2.trim().length()<=29)
               {
               	   ...
               	   Reporter.log("Error message: " +Passengerlastnme2);	
   	       	       ...
   	       	       final Screenshot screenshot8 = new AShot().shootingStrategy(new ViewportPastingStrategy(500)).takeScreenshot(driver);
		           final BufferedImage image8 = screenshot8.getImage();
		           ImageIO.write(image8, "PNG", new File("D:\\Ajit\\Script_SS\\OdysolAirHeldConfirmAndTicketedError\\13_Invalidlastname2.png"));
        ...
        try
        {
               ...
               if(Passengerfirstnme3.trim().length()<=29)
               {
		             ...
		             ImageIO.write(image9, "PNG", new File("D:\\Ajit\\Script_SS\\OdysolAirHeldConfirmAndTicketedError\\13_Invalidfirstname3.png"));
        ...
        try
        {
               ...
               if(Passengermdlnme3.trim().length()<=29)
               {
		             ...
		             ImageIO.write(image10, "PNG", new File("D:\\Ajit\\Script_SS\\OdysolAirHeldConfirmAndTicketedError\\14_Invalidlastname3.png"));
