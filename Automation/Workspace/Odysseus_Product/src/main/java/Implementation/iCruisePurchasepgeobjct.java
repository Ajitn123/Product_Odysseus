...
public class iCruisePurchasepgeobjct 
{
	         ...
	         //For Purchase page(Passenger details)
	         	...
	         	@FindBy(xpath="//*[@id='_ctl0_MainContentsPH__ctl0_TravelerAccount_1_AddressUC_CountrySel']")
	         	...
	         	@FindBy(xpath="//*[@id='_ctl0_MainContentsPH__ctl0_TravelerAccount_2_DateUC_Month']")
	         	private WebElement monthofgustwo;
	         	
	         	@FindBy(xpath="//*[@id='_ctl0_MainContentsPH__ctl0_TravelerAccount_2_DateUC_Day']")
	         	...
	         	private WebElement clkonbtn;
	              ...
	              public void iCruisePurchaseToTittle(String frstnme, String mdlnme, String lstnme, String emal, String phn, String frstnmofgstwo, String mdlnmofgstwo, String lstnmofgstwo)
	              {
	           	    try
	         	    {
	         		   ...
	         		   Thread.sleep(500);	
	         		   Select select11 = new Select(cntry.findElement(By.xpath("//*[@id='_ctl0_MainContentsPH__ctl0_TravelerAccount_1_AddressUC_CountrySel']")));
          			   select11.selectByVisibleText("United States");
                       Thread.sleep(800);
                       Select select111 = new Select(stte.findElement(By.xpath("//*[@id='_ctl0_MainContentsPH__ctl0_TravelerAccount_1_AddressUC_StateSel']")));
          			   select111.selectByVisibleText("Alaska");
                       Thread.sleep(800);
                       zpcde.sendKeys("10245");
                       Thread.sleep(600);
	         		   eml.clear();
	         		   Thread.sleep(200);
	         		   eml.click();
	         		   ...
	         		   Thread.sleep(900);
	         		   monthofgustwo.sendKeys(Keys.ENTER);
	         		   Thread.sleep(200);
	         		   monthofgustwo.findElement(By.xpath("//*[@id='_ctl0_MainContentsPH__ctl0_TravelerAccount_2_DateUC_Month']/option[9]")).click();
	         		   Thread.sleep(500);
	         		   dayofgustwo.sendKeys(Keys.ENTER);
	         		   Thread.sleep(300);
	         		   dayofgustwo.findElement(By.xpath("//*[@id='_ctl0_MainContentsPH__ctl0_TravelerAccount_2_DateUC_Day']/option[20]")).click();
	         		   Thread.sleep(500);
	         		   yrsofgustwo.sendKeys(Keys.ENTER);
	         		   Thread.sleep(300);
	         		   yrsofgustwo.findElement(By.xpath("//*[@id='_ctl0_MainContentsPH__ctl0_TravelerAccount_2_DateUC_Year']/option[15]")).click();
	         		   Thread.sleep(500);	
	         	...
	         	//	   Thread.sleep(2000);
	              ...
	              public void Click2cruisePurchaseToTittle(String frstnme, String mdlnme, String lstnme, String emal, String phn, String frstnmofgstwo, String mdlnmofgstwo, String lstnmofgstwo)
	              {
	           	    try
	         	    {
	         		   Select select1 = new Select(selectgender.findElement(By.xpath("//*[@id='_ctl0_MainContentsPH__ctl0_TravelerAccount_1_GenderSEL']")));
                       ...
                       Thread.sleep(600);
	         		   ...
	         		   eml.sendKeys(emal);
	         		   Thread.sleep(500);
	         		   phneforclick2cruise.clear();
	         		   Thread.sleep(500);
	         		   phneforclick2cruise.click();
	         		   Thread.sleep(500);
	         		   phneforclick2cruise.sendKeys(phn);
	         		   Thread.sleep(400);
	         		   Select select3 = new Select(slctitlofgustwo.findElement(By.xpath("//*[@id='_ctl0_MainContentsPH__ctl0_TravelerAccount_2_Title']")));
	         		   select3.selectByVisibleText("Mrs");
	         		   Thread.sleep(800);
