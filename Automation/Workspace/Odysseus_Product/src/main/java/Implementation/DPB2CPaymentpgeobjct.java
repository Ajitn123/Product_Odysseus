...
public class DPB2CPaymentpgeobjct
{
	   ...
	   //For payment details
		    ...
		    @FindBy(xpath="//*[@id='_ctl0_MainContentsPH__ctl0__ctl4_CreditCardInfo_expireDate_Month']")
		    private WebElement selectmonth;
		    
		    @FindBy(xpath="//*[@id='_ctl0_MainContentsPH__ctl0__ctl4_CreditCardInfo_expireDate_Year']")
		    private WebElement selectyear;
		    
		    @FindBy(id="_ctl0_MainContentsPH__ctl0__ctl4_BillingAddress_AddrLine1")
		    private WebElement address;
		    
		    @FindBy(xpath="//*[@id='_ctl0_MainContentsPH__ctl0__ctl4_BillingAddress_StateSel']")
		...
		public void DPB2CPaymentToTitle(String crdhldrnme, String crdno, String cardcvvno, String adrs, String cty, String zpcd, String phne, String bnknm)
		{
		    	try
		    	{
					...
					selectmonth.click();
					Thread.sleep(800);
					selectmonth.findElement(By.xpath("//*[@id='_ctl0_MainContentsPH__ctl0__ctl4_CreditCardInfo_expireDate_Month']/option[7]")).click();
					Thread.sleep(2000);
					selectyear.click();
					Thread.sleep(1500);
					...
					slectstate.click();
					Thread.sleep(300);
					slectstate.findElement(By.xpath("//*[@id='_ctl0_MainContentsPH__ctl0__ctl4_BillingAddress_StateSel']/option[14]")).click();
					Thread.sleep(500);
					slectcity.click();
					Thread.sleep(300);
