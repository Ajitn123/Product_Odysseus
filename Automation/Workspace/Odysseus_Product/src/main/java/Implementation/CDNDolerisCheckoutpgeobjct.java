...
public class CDNDolerisCheckoutpgeobjct
{
    ...
    //For Checkout page (For passenger 1)
	    ...
	    @FindBy(xpath="//*[@id='st-accordion']/ul/li[1]/div/div[9]/input")
	   ...
	   public void CDNDolerisToTitle(String frstnme, String mdlnme, String lstnme, String fstnm, String mdlnm, String lastnm, String firstnm, String midlnam, String lastnam, String eml, String coneml, String phone, String phn)
	   {
			try
			{
				...
				selctmonth.click();
				Thread.sleep(500);
				selctmonth.findElement(By.xpath("//*[@id='_ctl0_MainContentsPH__ctl0_BookingPassengers__ctl0_TravelerAccount_1_DateUC_Month']/option[5]")).click();
				Thread.sleep(500);
				selctday.click();
				Thread.sleep(500);
				selctday.findElement(By.xpath("//*[@id='_ctl0_MainContentsPH__ctl0_BookingPassengers__ctl0_TravelerAccount_1_DateUC_Day']/option[12]")).click();
				Thread.sleep(500);
				selctyear.click();
				Thread.sleep(500);
				selctyear.findElement(By.xpath("//*[@id='_ctl0_MainContentsPH__ctl0_BookingPassengers__ctl0_TravelerAccount_1_DateUC_Year']/option[44]")).click();
				Thread.sleep(1000);
				Select select1 = new Select(selecttitle.findElement(By.xpath("//*[@id='_ctl0__ctl0_MainContentsParentPH_MainContentsPH__ctl0_BookingPassengers__ctl1_TravelerAccount_2_Title']")));
				...
				slctmnth.click();
				Thread.sleep(300);
				slctmnth.findElement(By.xpath("//*[@id='_ctl0_MainContentsPH__ctl0_BookingPassengers__ctl1_TravelerAccount_2_DateUC_Month']/option[10]")).click();
				Thread.sleep(500);
				slctday.click();
				Thread.sleep(500);
				slctday.findElement(By.xpath("//*[@id='_ctl0_MainContentsPH__ctl0_BookingPassengers__ctl1_TravelerAccount_2_DateUC_Day']/option[10]")).click();
				Thread.sleep(500);
				slctyr.click();
				Thread.sleep(500);
				slctyr.findElement(By.xpath("//*[@id='_ctl0_MainContentsPH__ctl0_BookingPassengers__ctl1_TravelerAccount_2_DateUC_Year']/option[39]")).click();
				Thread.sleep(1000);
				slctitle.click();
				Thread.sleep(200);
				...
				slectmnth.click();
				Thread.sleep(200);
				slectmnth.findElement(By.xpath("//*[@id='_ctl0_MainContentsPH__ctl0_BookingPassengers__ctl2_TravelerAccount_3_DateUC_Month']/option[10]")).click();
				Thread.sleep(500);
				slectday.click();
				Thread.sleep(200);
				slectday.findElement(By.xpath("//*[@id='_ctl0_MainContentsPH__ctl0_BookingPassengers__ctl2_TravelerAccount_3_DateUC_Day']/option[18]")).click();
				Thread.sleep(500);
				slectyr.click();
				Thread.sleep(200);
				slectyr.findElement(By.xpath("//*[@id='_ctl0_MainContentsPH__ctl0_BookingPassengers__ctl2_TravelerAccount_3_DateUC_Year']/option[9]")).click();
				Thread.sleep(500);
