...
public class OdysolAirConfirmpgeobjct 
{
  ...
  public void ConfirmToTitle(String crdhldrnme, String crdno, String cardcvvno, String adrs, String cty, String zpcd, String phne)
  {
    	try
    	{
    		slctcarttype.click();
