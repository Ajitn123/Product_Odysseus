...
public class LocalTravelportBookingpgeobjct 
{
	      ...
	      // Search Air (Round Trip)
			...
			public void AirBookingToTitle(String frmloc, String tolc) 
			{
				try
				{
					...
					Thread.sleep(700);
					searchaffiliate.sendKeys("Odysseus");
					Thread.sleep(500);
				...
				//	selectfrmdte.click(); 
					...
					selectfrmdte.findElement(By.xpath("//*[@id='ui-datepicker-div']/div[2]/div/a/span")).click();
					Thread.sleep(700);
					selectfrmdte.findElement(By.xpath("//*[@id='ui-datepicker-div']/div[2]/table/tbody/tr[1]/td[3]/a")).click(); // 02 Jan 2018   
					Thread.sleep(3000);              
					Toloc.click(); 
					Toloc.sendKeys(tolc);
				...
				//	selecttodte.findElement(By.xpath("//*[@id='ui-datepicker-div']/div[2]/div/a/span")).click();
					selecttodte.findElement(By.xpath("//*[@id='ui-datepicker-div']/div[2]/table/tbody/tr[5]/td[4]/a")).click();  // 28 Feb 2018
					Thread.sleep(3000);
					selectadlt.click();        
