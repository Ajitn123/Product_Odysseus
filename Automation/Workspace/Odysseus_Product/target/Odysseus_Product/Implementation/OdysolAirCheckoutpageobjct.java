...
public class OdysolAirCheckoutpageobjct 
{
    ...
    @FindBy(id="InsurranceCHK_NON")
    private WebElement Insurance;
    
    @FindBy(xpath="//*[@id='st-accordion']/ul/li[4]/div/div[2]/input")
    private WebElement Submitinsurance;
    ...
    public void ConfirmToTitle(String frstnme, String lstnme, String fstnm, String lastnm, String firstnm, String lastnam, String eml, String phone, String crdhldrnme, String crdno, String cardcvvno, String adrs, String cty, String zpcd, String phne, String bnknme)
	{
		try
		{
    ...
    public void HoldToTitle(String frstnme, String mdlnme, String lstnme, String fstnm, String mdlnm, String lastnm, String firstnm, String middlnme, String lastnam, String eml, String cnfmeml, String phone)
	{
		try
		{
    ...
    public void AlanitaHoldToTitle(String frstnme, String mdlnme, String lstnme, String fstnm, String mdlnm, String lastnm, String firstnm, String middlnme, String lastnam, String eml, String cnfmeml, String phone)
	{
		try
		{
			...
			Thread.sleep(200);
			phoneatdestination.sendKeys("7854789658");
			Thread.sleep(500);
			continuebtn.click();
			Thread.sleep(1000);
			markupcontinuebtn.click();
