...
public class ADCRCCLPurchasepgeobjct
{
		...
		@FindBy(xpath="//*[@id='step5PaxInfo']/table[5]/tbody/tr[1]/td/div/div[1]/a")
		...
		private WebElement clkonbtn;
		 ...
		 public void ADCPurchaseToTittle(String frstnme, String mdlnme, String lstnme, String emal, String phn, String strtaddr, String cti, String zipcde, String frstnmofgstwo, String mdlnmofgstwo, String lstnmofgstwo)
		 {
			  ...
			  try
			  {
					   ...
					   anniversary.findElement(By.xpath("//*[@id='SServ_ANV_0']/option[1]")).click();
					   anniversary.sendKeys(Keys.TAB);
					   howmanyears.sendKeys("1");
					   howmanyears.sendKeys(Keys.TAB);
					   bdaygustone.findElement(By.xpath("//*[@id='SServ_BDY_0']/option[1]")).click();
					   bdaygustone.sendKeys(Keys.TAB);
					   bdaygusttwo.findElement(By.xpath("//*[@id='SServ_BDY_1']/option[1]")).click();
					   bdaygusttwo.sendKeys(Keys.TAB);
					   honymoon.findElement(By.xpath("//*[@id='SServ_CAK_0']/option[1]")).click();
					   honymoon.sendKeys(Keys.TAB);
