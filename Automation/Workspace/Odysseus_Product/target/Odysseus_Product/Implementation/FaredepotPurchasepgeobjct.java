...
public class FaredepotPurchasepgeobjct
{
	    ...
	    public void FaredepotToTitle(String frstnme, String mdlnme, String lstnme, String fstnm, String mdlnm, String lastnm, String firstnm, String midlnam, String lastnam, String eml, String coneml, String phone, String phn)
		{
			try
			{
				Select select = new Select(selctitle.findElement(By.xpath("//*[@id='_ctl0__ctl0_MainContentsParentPH_MainContentsPH__ctl0_BookingPassengers__ctl0_TravelerAccount_1_Title']")));
				...
				selctmonth.click();
				Thread.sleep(500);
				selctmonth.findElement(By.xpath("//*[@id='_ctl0__ctl0_MainContentsParentPH_MainContentsPH__ctl0_BookingPassengers__ctl0_TravelerAccount_1_DateUC_Month']/option[8]")).click();
				Thread.sleep(500);
				selctday.click();
				Thread.sleep(500);
				selctday.findElement(By.xpath("//*[@id='_ctl0__ctl0_MainContentsParentPH_MainContentsPH__ctl0_BookingPassengers__ctl0_TravelerAccount_1_DateUC_Day']/option[24]")).click();
				Thread.sleep(500);
				selctyear.click();
				Thread.sleep(500);
				selctyear.findElement(By.xpath("//*[@id='_ctl0__ctl0_MainContentsParentPH_MainContentsPH__ctl0_BookingPassengers__ctl0_TravelerAccount_1_DateUC_Year']/option[73]")).click();
				Thread.sleep(1000);
				...
				slctmnth.click();
				Thread.sleep(300);
				slctmnth.findElement(By.xpath("//*[@id='_ctl0__ctl0_MainContentsParentPH_MainContentsPH__ctl0_BookingPassengers__ctl1_TravelerAccount_2_DateUC_Month']/option[6]")).click();
				Thread.sleep(500);
				slctday.click();
				Thread.sleep(500);
				slctday.findElement(By.xpath("//*[@id='_ctl0__ctl0_MainContentsParentPH_MainContentsPH__ctl0_BookingPassengers__ctl1_TravelerAccount_2_DateUC_Day']/option[19]")).click();
				Thread.sleep(500);
				slctyr.click();
				Thread.sleep(500);
				slctyr.findElement(By.xpath("//*[@id='_ctl0__ctl0_MainContentsParentPH_MainContentsPH__ctl0_BookingPassengers__ctl1_TravelerAccount_2_DateUC_Year']/option[75]")).click();
				Thread.sleep(1000);
				slctitle.click();
				Thread.sleep(200);
