...
public class LocalDynamicPackagingPaymentpgobjct
{
	...
	public void DynamicPaymentToTitle(String crdno, String cardcvvno, String crdhldrnme)
	{
	    	try
	    	{
				...
				slctcarttype.click();
				Thread.sleep(500);
				slctcarttype.findElement(By.xpath("//*[@id='_ctl0_MainContentsPH__ctl0_CreditCardInfo_cardType']/option[6]")).click();
				Thread.sleep(500);  
				cardno.click();
				Thread.sleep(300);
